...
import BaseballFourDigitDropDown from "../../components/baseball-components/baseball-four-digit-dropdown";
...
export default function BaseBallFourDigit() {
    ...
    return (
        <Wrapper>
            <InfoWrapper>
                ...
                <H1>Type : Baseball Game (4 digits)</H1>
                {playerA && playerB ? (
                    <>
            ...
            <GamePlayWrapper>
                <FormWrapper>
                    <BaseballFourDigitDropDown isClickable={hasSubmit} buttonText="Submit Number" onButtonClick={submitSecretNumber} />
                    <BaseballFourDigitDropDown isClickable={!isMyTurn} buttonText="Guess Number" onButtonClick={guessNumber} />
                </FormWrapper>
